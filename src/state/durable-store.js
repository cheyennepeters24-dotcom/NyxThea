...
export const durableTables = ["profiles", "profile_grants", "access_audit", "memories", "person_models", "profile_identity", "households", "household_memberships", "profile_relationships", "profile_devices", "profile_locks", "profile_lock_challenges", "settings_authorizations", "emergency_policies", "emergency_incidents", "experience_settings", "later_queue", "agency_jobs", "auth_accounts", "auth_sessions", "profile_claim_invites", "auth_rate_limits", "voice_transcription_limits", "alexa_oauth_codes", "alexa_oauth_tokens"];
