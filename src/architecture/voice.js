...
export function voicePlan(){return {identity:"NyxThea",aliases:["NYX","Nixie"],baseline:CORE_VOICE,activation:"User-enabled, foreground browser session; stops after five minutes, on navigation, or on sign-out. Background wake on iPhone is unavailable.",rule:"Voice recognition is convenience, never authentication.",fallback:"If browser wake recognition is unavailable, use the tap-to-talk microphone or text."};}
